 ...
 */
class SpyLocaleStoreEntityTransfer extends AbstractEntityTransfer
{
    /**
     * @var string
     */
    public const ID_LOCALE_STORE = 'idLocaleStore';
    ...
    protected $transferPropertyNameMap = [
        'id_locale_store' => 'idLocaleStore',
        'idLocaleStore' => 'idLocaleStore',
        'IdLocaleStore' => 'idLocaleStore',
        'fk_locale' => 'fkLocale',
        'fkLocale' => 'fkLocale',
        'FkLocale' => 'fkLocale',
    ...
    protected $transferMetadata = [
        self::ID_LOCALE_STORE => [
            'type' => 'integer',
            'type_shim' => null,
            'name_underscore' => 'id_locale_store',
            'is_collection' => false,
            'is_transfer' => false,
     ...
     * @var string
     */
    public static $entityNamespace = 'Orm\Zed\Locale\Persistence\SpyLocaleStore';


    /**
     * @module 
     *
     * @param integer|null $idLocaleStore
     *
     * @return $this
     */
    public function setIdLocaleStore($idLocaleStore)
    {
        $this->idLocaleStore = $idLocaleStore;
        $this->modifiedProperties[self::ID_LOCALE_STORE] = true;
     ...
     * @return $this
     */
    public function setIdLocaleStoreOrFail($idLocaleStore)
    {
        if ($idLocaleStore === null) {
            $this->throwNullValueException(static::ID_LOCALE_STORE);
        }

        return $this->setIdLocaleStore($idLocaleStore);
    }
     ...
     * @return integer
     */
    public function getIdLocaleStoreOrFail()
    {
        if ($this->idLocaleStore === null) {
            $this->throwNullValueException(static::ID_LOCALE_STORE);
        }
     ...
     * @return $this
     */
    public function requireIdLocaleStore()
    {
        $this->assertPropertyIsSet(self::ID_LOCALE_STORE);
    ...
    {
        return [
            'idLocaleStore' => $this->idLocaleStore,
    ...
    {
        return [
            'id_locale_store' => $this->idLocaleStore,
    ...
    {
        return [
            'id_locale_store' => $this->idLocaleStore instanceof AbstractTransfer ? $this->idLocaleStore->toArray(true, false) : $this->idLocaleStore,
    ...
    {
        return [
            'idLocaleStore' => $this->idLocaleStore instanceof AbstractTransfer ? $this->idLocaleStore->toArray(true, true) : $this->idLocaleStore,
